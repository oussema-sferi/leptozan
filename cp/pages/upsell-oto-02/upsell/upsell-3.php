...
<html lang="en">
    <head>
        <!-- header start -->
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/glucozan/header.php'; ?>
        <!-- header end -->

        <?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/cartpanda-head-script.php'; ?>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/glucozan/google-tag-manager-body.php'; ?>
    ...
    <!-- Home Page Section Start -->
        ...
        <div class="main-wrpper glucozan-home-page-section">
            <!-- Hero Banner -->
            <section class="hero-banner" style="background-image:url('/cp/images/glucozan/banner-image.jpg');">
                <div class="container">
                        ...
                        <ul>
                            ...
                            <li class="active-step">
                                <div class="step-box">
                                    ...
                                    <div class="step-data">
                                        <h3>Special upgrade</h3>
                                        <p>Important Announcement</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="step-box panding-step">
                                    <div class="step-ic">
                                        <h2>3</h2>
                                    </div>
                                    <div class="step-data">
            ...
            <!-- Dr. Mitchell -->
            <section class="dr-mitchell-wrp">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="dr-mitchell-img">
                                <figure>
                                    <img src="/cp/images/glucozan/dr-mitchell.webp" alt="Dr Mitchell">
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="visious-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/visious-img.png" alt="Vicious">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <div class="discovering-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/discovering-img.png" alt="discovering-img">
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="glucozan-row">
                        ...
                        <div class="glucozan-img">
                            <figure>
                                <img src="/cp/images/glucozan/glucozan-img.png" alt="glucozan-img">
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="why-glucozan-block">
                                <div class="why-glucozan-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/glucozan-img1.png" alt="glucozan-img">
                                    </figure>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="why-glucozan-block">
                                <div class="why-glucozan-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/glucozan-img2.png" alt="glucozan-img">
                                    </figure>
                                </div>
                                <div class="why-glucozan-data">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="why-glucozan-block">
                                <div class="why-glucozan-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/glucozan-img3.png" alt="glucozan-img">
                                    </figure>
                                </div>
                                <div class="why-glucozan-data">
                                    <h4>Oleuropein</h4>
                ...
                <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <div class="experience-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/experience-img.png" alt="experience-img">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                <div class="potential-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/potential-img.png" alt="Potential-img">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-7 col-sm-12">
                    ...
                    <div class="experience-glucozan-shortbx">
                        ...
                        <div class="experience-glucozan-img-shortbx">
                            <figure>
                                <img src="/cp/images/glucozan/full-potential-img.png" alt="full-potential-img">
                            </figure>
                        </div>
            ...
            <!-- Try Glucozan Risk-Free -->
            <section class="glucozan-riskfree-wrp">
                <div class="container">
                    <div class="riskfree-block">
                        <figure>
                            <img src="/cp/images/glucozan/money-backimg@2x.png" alt="Risk Free">
                        </figure>
                ...
                <div class="container">
                    ...
                    <div class="price-row">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block first">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/1.png" alt="Product">
                                            <div class="guarantee-badge">
                                                <img src="/cp/images/guarantee-badge.png" alt="Guarantee">
                                            </div>
                                        </figure>
                                    </div>

                                    <div class="product-databx">
                                        <h3><strong>$</strong>69<span>Per<br>Bottle</span></h3>

                                        <p>+ FREE SHIPPING</p>

                                        <a href="https://leptozan.mycartpanda.com/ex-ocu/next-offer/1qjokxNjJD-w2ArGx4J6V?accepted=yes" class="btn-main">BUY NOW <span>BEST OFFER</span></a>

                                        <h6>TOTAL: <strong>$69</strong></h6>

                                        <div class="pay-box">
                                            <ul>
                                                <li><figure><img src="/cp/images/glucozan/pay-ic1.svg" alt="Pay"></figure></li>
                                                <li><figure><img src="/cp/images/glucozan/pay-ic2.svg" alt="Pay"></figure></li>
                                                <li><figure><img src="/cp/images/glucozan/pay-ic3.svg" alt="Pay"></figure></li>
                                                <li><figure><img src="/cp/images/glucozan/pay-ic4.svg" alt="Pay"></figure></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block popular-block">
                                    <div class="pricing-top">
                                        ...
                                        <h3>6 Bottles</h3>
                                        <h6>6-Month Supply</h6>
                                    </div>

                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/6.png" alt="Product">
                                            <div class="guarantee-badge">
                                                <img src="/cp/images/guarantee-badge.png" alt="Guarantee">
                                            </div>
                                        </figure>
                                    ...
                                    <div class="product-databx">
                                        <h3><b><sup>$</sup>69</b><strong>$</strong>39<span>Per<br>Bottle</span></h3>

                                        <p>+ FREE SHIPPING</p>

                                        <a href="https://leptozan.mycartpanda.com/ex-ocu/next-offer/1qjokxNjJD-ojREJ9wByY?accepted=yes" class="btn-main">BUY NOW <span>BEST OFFER</span></a>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/3.png" alt="Product">
                                            <div class="guarantee-badge">
                                                <img src="/cp/images/guarantee-badge.png" alt="Guarantee">
                                            </div>
                                        </figure>
                                    ...
                                    <div class="product-databx">
                                        <h3><b><sup>$</sup>69</b><strong>$</strong>49<span>Per<br>Bottle</span></h3>

                                        <p>+ FREE SHIPPING</p>

                                        <a href="https://leptozan.mycartpanda.com/ex-ocu/next-offer/1qjokxNjJD-qjoE1zpZBV?accepted=yes" class="btn-main">BUY NOW <span>BEST OFFER</span></a>
                        ...
                        <div class="price-notebox">
                            ...
                            <a id="no-thanks-button" href="https://leptozan.mycartpanda.com/ex-ocu/next-offer/1qjokxNjJD-w2ArGx4J6V?accepted=no" class="btn-secondary">No, thanks</a>
                        </div>
                    </div>

                    <div class="suppliers-row">
                        <div class="suppliers-rw">
                            <ul>
                                <li>
                                    <figure>
                                        <img src="/cp/images/glucozan/sup-logo1.svg" alt="Supply">
                                    </figure>
                                </li>
                                <li>
                                    <figure>
                                        <img src="/cp/images/glucozan/sup-logo2.svg" alt="Supply">
                                    </figure>
                                </li>
                                <li>
                                    <figure>
                                        <img src="/cp/images/glucozan/sup-logo3.svg" alt="Supply">
                                    </figure>
                                </li>
                                <li>
                                    <figure>
                                        <img src="/cp/images/glucozan/sup-logo4.svg" alt="Supply">
                                    </figure>
                                </li>
                                <li>
                                    <figure>
                                        <img src="/cp/images/glucozan/sup-logo5.svg" alt="Supply">
                                    </figure>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="supply-banner-img">
                            <figure>
                                <a href="#" class="banner-popup-trigger">
                                    <img src="/cp/images/glucozan/banner-card@2x.png" alt="Banner">
                    ...
                    <div id="banner-lightbox" class="lightbox-overlay">
                        <div class="lightbox-container">
                            ...
                            <img class="lightbox-image" src="/cp/images/glucozan/banner-card@2x.png" alt="Banner">
                        </div>
                    </div>

                    <div class="scientific-references-block">
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                <div class="scientific-img">
                                    <figure>
                                        <img src="/cp/images/glucozan/product-big.png" alt="glucozan-img">
                                    </figure>   
                                </div>
                            </div>
                            <div class="col-md-7 col-sm-12">
                                <div class="scientific-data">
                                    ...
                                    <ul>
                                        <li><a href="#" translate="_blank">https://pubmed.ncbi.nlm.nih.gov/28619294/</a></li>
                                        <li><a href="#" translate="_blank">https://pubmed.ncbi.nlm.nih.gov/22095937/</a></li>
                                        <li><a href="#" translate="_blank">https://www.sciencedirect.com/science/article/abs/pii/S2405457718304698</a></li>
                                        <li><a href="#" translate="_blank">https://pubmed.ncbi.nlm.nih.gov/21211558/</a></li>
                                        <li><a href="#" translate="_blank">https://pmc.ncbi.nlm.nih.gov/articles/PMC10650557/</a></li>
                                        <li><a href="#" translate="_blank">https://pmc.ncbi.nlm.nih.gov/articles/PMC6415286/</a></li>
                                        <li><a href="#" translate="_blank">https://www.sciencedirect.com/science/article/abs/pii/S0378874120330981</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <!-- footer start -->
            <?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/glucozan/footer.php'; ?>
            <!-- footer end -->
        </div>
