...
<!-- header start -->
<?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/index-navbar.php'; ?>
<!-- header end -->
...
<header class="header-mobile-view">
    <div class="custom-header-container text-left">
        <div class="mobile-view-logo-container">
            <a href="/cp/cp/">
                <figure>
                    <img src="/cp/images/logo.png" alt="logo" class="img-fluid" style="width: 90px; height: auto;">
                </figure>
            </a>
        </div>
    </div>
					...
					<div class="row align-items-center">
						...
						<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6">
							<div class="banner-img">
								<figure>
									<img src="/cp/images/Product.png" alt="Product" class="img-fluid">
								</figure>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/fat-loss.svg" alt="fat-loss" class="img-fluid">
									</figure>
								</div>
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/metabolism.svg" alt="metabolism" class="img-fluid">
									</figure>
								</div>
								<div class="healthy-content">
									<div class="block-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/fast-food.svg" alt="fast-food" class="img-fluid">
									</figure>
								</div>
								<div class="healthy-content">
									<div class="block-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/power.svg" alt="power" class="img-fluid">
									</figure>
								</div>
								<div class="healthy-content">
									<div class="block-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/digestive-organ.svg" alt="digestive-organ" class="img-fluid">
									</figure>
								</div>
								<div class="healthy-content">
									<div class="block-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="healthy-block">
								<div class="healthy-icon">
									<figure>
										<img src="/cp/images/eco.svg" alt="eco" class="img-fluid">
									</figure>
								</div>
								<div class="healthy-content">
									<div class="block-title">
			...
			<div class="ingredients-main">
				<div class="ingredients-logos-main">
					<div class="ingredients-logos">
						<figure>
							<img src="/cp/images/logo-1.png" alt="logo" class="img-fluid">
						</figure>
					</div>
					<div class="ingredients-logos">
						<figure>
							<img src="/cp/images/logo-2.png" alt="logo" class="img-fluid">
						</figure>
					</div>
					<div class="ingredients-logos">
						<figure>
							<img src="/cp/images/logo-3.png" alt="logo" class="img-fluid">
						</figure>
					</div>
					<div class="ingredients-logos">
						<figure>
							<img src="/cp/images/logo-4.png" alt="logo" class="img-fluid">
						</figure>
					</div>
					<div class="ingredients-logos">
						<figure>
							<img src="/cp/images/logo-5.png" alt="logo" class="img-fluid">
						</figure>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="ingredients-block">
								<div class="ingredients-img">
									<figure>
										<img src="/cp/images/ingredients-img-1.jpg" alt="ingredients-img" class="img-fluid">
									</figure>
								</div>
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="ingredients-block">
								<div class="ingredients-img">
									<figure>
										<img src="/cp/images/ingredients-img-2.jpg" alt="ingredients-img" class="img-fluid">
									</figure>
								</div>
								<div class="ingredients-content">
									<div class="small-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4">
							<div class="ingredients-block">
								<div class="ingredients-img">
									<figure>
										<img src="/cp/images/ingredients-img-3.jpg" alt="ingredients-img" class="img-fluid">
									</figure>
								</div>
								<div class="ingredients-content">
									<div class="small-title">
						...
						<div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 order-3 order-md-1">
							<div class="offers-block">
								...
								<div class="offers-inner">
									...
									<div class="offers-btn">
										<a href="#" class="btn btn-yellow">BUY NOW <span>Basic Offer!</span></a>
									</div>
									<div class="payments-block">
										<ul>
											<li>
				...
				<div class="row">
					<div class="col-lg-6 col-xl-6 col-xxl-6">
						<div class="references-img">
							<figure>
								<img src="/cp/images/reference-img.png" alt="reference-img" class="img-fluid">
							</figure>
						</div>
					</div>
					<div class="col-lg-6 col-xl-6 col-xxl-6">
