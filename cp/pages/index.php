...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/google-tag-manager-body.php'; ?>
...
<nav class="navbar navbar-expand-md fixed-navbar">
    <div class="container">
        <a class="navbar-brand" href="/cp/">
            <img src="/cp/images/logo.png" alt="logo" class="img-fluid">
        </a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="banner-img">
                                <figure>
                                    <img src="/cp/images/new/Product.png" alt="Product" class="img-fluid">
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ingredients-main">
                ...
                <div class="ingredients-logos-main">
                    <div class="ingredients-logos">
                        <figure>
                            <img src="/cp/images/leptozan-new-logos/guarantee/logo-1.png" alt="logo" class="img-fluid">
                        </figure>
                    </div>
                    <div class="ingredients-logos">
                        <figure>
                            <img src="/cp/images/leptozan-new-logos/guarantee/logo-2.png" alt="logo" class="img-fluid">
                        </figure>
                    </div>
                    <div class="ingredients-logos">
                        <figure>
                            <img src="/cp/images/leptozan-new-logos/guarantee/logo-3.png" alt="logo" class="img-fluid">
                        </figure>
                    </div>
                    <div class="ingredients-logos">
                        <figure>
                            <img src="/cp/images/leptozan-new-logos/guarantee/logo-4.png" alt="logo" class="img-fluid">
                        </figure>
                    </div>
                    <div class="ingredients-logos">
                        <figure>
                            <img src="/cp/images/leptozan-new-logos/guarantee/logo-5.png" alt="logo" class="img-fluid">
                        </figure>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="ingredients-block horizontal">
                                <div class="ingredients-block-inner">
                                    <div class="ingredients-img">
                                        <figure>
                                            <img src="/cp/images/leptozan-new-ingredients/ingredients-img-1.png" alt="ingredients-img" class="img-fluid">
                                        </figure>
                                    </div>
                            ...
                            <div class="ingredients-block horizontal">
                                <div class="ingredients-block-inner">
                                    <div class="ingredients-img">
                                        <figure>
                                            <img src="/cp/images/leptozan-new-ingredients/ingredients-img-2.png" alt="ingredients-img" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="ingredients-content">
                                        <div class="small-title">
                        ...
                        <div class="col-lg-5">
                            <div class="ingredients-block vertical">
                                <div class="ingredients-img">
                                    <figure>
                                        <img src="/cp/images/leptozan-new-ingredients/ingredients-img-3.png" alt="ingredients-img" class="img-fluid">
                                    </figure>
                                </div>
                                <div class="ingredients-content">
                                    <div class="small-title">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-content-wrapper">
                                            ...
                                            <div class="offers-product-img">
                                                <figure>
                                                    <img src="/cp/images/2-bottles.png" alt="offers-img" class="img-fluid bottle-img">
                                                </figure>
                                            </div>
                                    ...
                                    <div class="offers-btn">
                                        <!--<a href="/cp/cp/upsell-oto-01/?sku=lepto-us-01" class="btn btn-yellow">BUY NOW <span>Basic Offer!</span></a>-->
                                        <a href="https://leptozan.mycartpanda.com/checkout/182068179:1" class="btn btn-yellow">BUY NOW <span>Basic Offer!</span></a>
                                    </div>
                                    <div class="payments-block">
                                        <ul>
                                            <li>
                                                <figure>
                                                    <img src="/cp/images/Mastercard.svg" alt="Mastercard" class="img-fluid">
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src="/cp/images/visa-logo.svg" alt="visa" class="img-fluid">
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src="/cp/images/amex.svg" alt="amex" class="img-fluid">
                                                </figure>
                                            </li>
                                            <li>
                                                <figure>
                                                    <img src="/cp/images/discover.svg" alt="discover" class="img-fluid">
                                                </figure>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="offers-block best-offer-block">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-content-wrapper">
                                        <div class="offers-product-img">
                                            <figure>
                                                <img src="/cp/images/6-bottles.png" alt="offers-img" class="img-fluid bottle-img">
                                                <!--<img src="/cp/images/guarantee-badge.png" alt="Money Back Guarantee" class="guarantee-badge">-->
                                            </figure>
                                        </div>
                                        <div class="offers-info-wrapper">
                                    ...
                                    <div class="offers-btn">
                                        <!--<a href="/cp/cp/upsell-oto-01/?sku=lepto-us-06" class="btn btn-orange">BUY NOW <span>Best Offer!</span></a>-->
                                        <a href="https://leptozan.mycartpanda.com/checkout/182068579:1" class="btn btn-orange">BUY NOW <span>Best Offer!</span></a>
                                    </div>
                                    <div class="payments-block">
                                        <ul>
                                            <li>
                            ...
                            <div class="offers-block desktop-view">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-content-wrapper">
                                        <div class="offers-product-img">
                                            <figure>
                                                <img src="/cp/images/3-bottles.png" alt="offers-img" class="img-fluid bottle-img">
                                                <!--<img src="/cp/images/guarantee-badge-2.png" alt="Money Back Guarantee" class="guarantee-badge">-->
                                            </figure>
                                        </div>
                                        <div class="offers-info-wrapper">
                                            <!-- Price and list content -->
                                    ...
                                    <div class="offers-btn">
                                        <!--<a href="/cp/cp/upsell-oto-01/?sku=lepto-us-03" class="btn btn-yellow">BUY NOW <span>Good Offer!</span></a>-->
                                        <a href="https://leptozan.mycartpanda.com/checkout/182068509:1" class="btn btn-yellow">BUY NOW <span>Good Offer!</span></a>
                                    </div>
                                    <div class="payments-block">
                                        <ul>
                                            <li>
    ...
    <section class="guarantee-wrp">
        <div class="container">
            <div class="guarantee-main">
                <!--<div class="badge-img">
                    <figure>
                        <img src="/cp/images/badge.png" alt="badge" class="img-fluid">
                    </figure>
                </div>-->
                <div class="section-title">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 order-3 order-md-1">
                            <div class="offers-block">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-product-img">
                                        <figure>
                                            <img src="/cp/images/offers-img-1.png" alt="offers-img" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="offers-product-price">
                                        <h3><b>$</b><span>79</span><small>Per Bottle</small></h3>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 order-1 order-md-2">
                            <div class="offers-block best-offer-block">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-product-img">
                                        <figure>
                                            <img src="/cp/images/offers-img-2.png" alt="offers-img" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="offers-product-price">
                                        <h3><b>$</b><span>49</span><small>Per Bottle</small></h3>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-4 order-2 order-md-3">
                            <div class="offers-block">
                                ...
                                <div class="offers-inner">
                                    <div class="offers-product-img">
                                        <figure>
                                            <img src="/cp/images/offers-img-3.png" alt="offers-img" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="offers-product-price">
                                        <h3><b>$</b><span>69</span><small>Per Bottle</small></h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        <div class="references-img">
                            <figure>
                                <img src="/cp/images/new/Product.png" alt="reference-img" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
...
<!-- footer start -->
<?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/footer.php'; ?>
<!-- footer end -->

<!-- scripts start -->
<?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/scripts.php'; ?>
<script src="/cp/js/custom/index.js?v=<?php echo time(); ?>"></script>
<!-- scripts end -->
