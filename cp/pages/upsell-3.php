...
<div class="content">
    ...
    <section class="vsl-banner-wrp vsl-banner-wrp2 upsell-page" style="background-color: #D4F1F2;">
        <div class="container">
            <div class="vsl-banner-main">
                <div class="banner-order-steps">
                    <div class="order-step">
                        <div class="icon" style="background-color: var(--orange);">
                            <figure>
                                <img src="/cp/images/Subtract.svg" alt="order-img" class="img-fluid">
                            </figure>
                        </div>
                ...
                <div class="vsl-video">
                    <!--<video class="video" poster="/cp/images/video-poster.jpg">
                        <source src="/cp/images/mov_bbb.mp4" type="video/mp4">
                    </video>
                    <a href="#" class="play-icon">
                        <figure>
                            <img src="/cp/images/play-icon.svg" alt="play-icon" class="img-fluid">
                        </figure>
                    </a>-->
                    <!-- Vidalytics Embed -->
                    ...
                    <div id="vid_67d3392b653b10e968e05d9a" style="width: 100%; position:relative; padding-top: 56.25%;"></div>
                    <script type="text/javascript" id="scr_67d3392b653b10e968e05d9a">
                        var s=document.createElement("script"); s.src="https://scripts.converteai.net/2d86efbf-e9a0-49b5-8604-c3045db2ac7e/players/67d3392b653b10e968e05d9a/player.js", s.async=!0,document.head.appendChild(s);
                    </script>
    ...
    <section class="banner-upsell" style="background-color: #ED4E1E; display: none">
        <div class="banner-shape">
            <figure>
                <img src="/cp/images/banner-2.png" alt="banner-img" class="img-fluid">
            </figure>
        </div>
        <div class="container">
                                ...
                                <div class="special-deal-img text-center" style="background-color: var(--white);">
                                    <figure>
                                        <div style="position: relative;">
                                            ...
                                            <a href="https://buygoods.com/secure/upsell/?account_id=10880&product_codename=lep6u&redirect=aHR0cHM6Ly9sZXB0b3phbi5jb20vdXBzZWxsLW90by0wMi8=" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10; opacity: 0;"></a>
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="special-deal-right">
                                    ...
                                    <div class="right-details text-center" style="background: #41A3A3; color: var(--white);">
                                        <div class="right-details-img">
                                            <figure>
                                                ...
                                                <img src="/cp/images/total-saving2.png" alt="total-saving" class="img-fluid">
                                            </figure>
                                        </div>
                                        <div class="small-title">
                                            <span>Total</span>
                                ...
                                <div class="btn-contain">
                                    <a href="https://buygoods.com/secure/upsell/?account_id=10880&product_codename=lep6u&redirect=aHR0cHM6Ly9sZXB0b3phbi5jb20vdXBzZWxsLW90by0wMi8=" class="btn btn-orange w-100">YES! UPGRADE MY ORDER <br> <span>For Only $294</span> </a>
                                </div>
                                <div class="icon-list">
                                    <ul>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="special-deal-left">
                                ...
                                <div class="special-deal-img text-center" style="background-color: var(--white);">
                                    <figure>
                                        <div style="position: relative;">
                                            <img style="cursor: pointer" width="400" src="/cp/images/3-bottles.png" alt="order-img" class="img-fluid"
                                            <!-- Overlay link that covers the image without changing layout -->
                                            <a href="https://buygoods.com/secure/upsell/?account_id=10880&product_codename=lep3d&redirect=aHR0cHM6Ly9sZXB0b3phbi5jb20vdXBzZWxsLW90by0wMi8=" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 10; opacity: 0;"></a>
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="special-deal-right">
                                ...
                                <div class="btn-contain">
                                    <a href="https://buygoods.com/secure/upsell/?account_id=10880&product_codename=lep3d&redirect=aHR0cHM6Ly9sZXB0b3phbi5jb20vdXBzZWxsLW90by0wMi8=" class="btn btn-orange w-100">YES! UPGRADE MY ORDER <br> <span>For Only $<span class="price">177</span></span> </a>
                                </div>
                                <div class="icon-list">
                                    <ul>
                                        <li><a href="#"><img src="/cp/images/badge1.png" alt="badge"></a></li>
        ...
        <div class="container">
            <div class="official-page-wrap text-center">
                ...
                <div class="official-page-logo">
                    <ul>
                        <li><a href="#"><img src="/cp/images/amazon.png" alt="img"></a></li>
                        <li><a href="#"><img src="/cp/images/ebay.png" alt="img"></a></li>
                        <li><a href="#"><img src="/cp/images/walmart 1.png" alt="img"></a></li>
                        <li><a href="#"><img src="/cp/images/available.png" alt="img"></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php /*include $_SERVER['DOCUMENT_ROOT'] . '/cp/js/custom/upsell.js'; */?>
<script src="/cp/js/custom/upsell.js"></script>
