...
<html lang="en">
    <head>
        <!-- header start -->
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/cp/components/glucozan/backup/header.php'; ?>
        <!-- header end -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="dr-mitchell-img">
                                <figure>
                                    <img src="/cp/images/glucozan/dr-mitchell.png" alt="Dr Mitchell">
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/product-img1.png" alt="Product">
                                        </figure>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block popular-block">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/product-img2.png" alt="Product">
                                        </figure>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="pricing-block">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/product-img3.png" alt="Product">
                                        </figure>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="pricing-block popular-block">
                                    ...
                                    <div class="product-img">
                                        <figure>
                                            <img src="/cp/images/glucozan/no-pro2.png" alt="Product">
                                        </figure>
                                    </div>
