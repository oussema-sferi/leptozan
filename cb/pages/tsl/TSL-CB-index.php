...
<nav class="navbar navbar-expand-md fixed-navbar">
    <div class="container">
        <a class="navbar-brand" href="/cb/tsl">
            <img src="/cb/images/logo.png" alt="logo" class="img-fluid">
        </a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="banner-img">
                                <figure>
                                    <img src="/cb/images/new/Product.png" alt="Product" class="img-fluid">
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="feature-box orange-bg">
                                <h4>Support Healthy Metabolism</h4>
                                <p>Support metabolic health to burn more calories all day, every day.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="feature-box light-bg">
                        ...
                        <div class="col-md-4">
                            <div class="feature-box light-bg">
                                <h4>Anti-inflammatory Support</h4>
                                <p>Helps maintain a balanced inflammatory function: an important factor in overall wellness and vitality.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="feature-box orange-bg">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="ingredients-block horizontal">
                                <div class="ingredients-block-inner">
                                    <div class="ingredients-img">
                                        <figure>
                                            <img src="/cb/images/leptozan-new-ingredients/ingredients-img-1.png" alt="ingredients-img" class="img-fluid">
                                        </figure>
                                    </div>
                            ...
                            <div class="ingredients-block horizontal">
                                <div class="ingredients-block-inner">
                                    <div class="ingredients-img">
                                        <figure>
                                            <img src="/cb/images/leptozan-new-ingredients/ingredients-img-2.png" alt="ingredients-img" class="img-fluid">
                                        </figure>
                                    </div>
                                    <div class="ingredients-content">
                                        <div class="small-title">
                        ...
                        <div class="col-lg-5">
                            <div class="ingredients-block vertical">
                                <div class="ingredients-img">
                                    <figure>
                                        <img src="/cb/images/leptozan-new-ingredients/ingredients-img-3.png" alt="ingredients-img" class="img-fluid">
                                    </figure>
                                </div>
                                <div class="ingredients-content">
                                    <div class="small-title">
                            ...
                            <div class="offers-block desktop-view">
                                ...
                                <div class="offers-inner">
                                    ...
                                    <div class="offers-btn">
                                        <!--<a href="/cb/upsell-oto-01/?sku=lepto-us-02" class="btn btn-yellow">BUY NOW <span>Basic Offer!</span></a>-->
                                        <a href="https://leptozan.pay.clickbank.net/?cbitems=lepto-us-02&vtid=main_tsl_01&cbfid=59441&template=chk01" class="btn btn-yellow">BUY NOW <span>Basic Offer!</span></a>
                                    </div>
                            ...
                            <div class="offers-block best-offer-block">
                                ...
                                <div class="offers-inner">
                                    ...
                                    <div class="offers-btn">
                                        ...
                                        <a href="https://leptozan.pay.clickbank.net/?cbitems=lepto-us-06&vtid=main_tsl_01&cbfid=59443&template=chk01" class="btn btn-orange">BUY NOW <span>Best Offer!</span></a>
                                    </div>
                                    <div class="payments-block">
                                        <ul>
                                            <li>
                            ...
                            <div class="offers-block desktop-view">
                                ...
                                <div class="offers-inner">
                                    ...
                                    <div class="offers-btn">
                                        ...
                                        <a href="https://leptozan.pay.clickbank.net/?cbitems=lepto-us-03&vtid=main_tsl_01&cbfid=59442&template=chk01" class="btn btn-yellow">BUY NOW <span>Good Offer!</span></a>
                                    </div>
                                    <div class="payments-block">
                                        <ul>
                                            <li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        <div class="references-img">
                            <figure>
                                <img src="/cb/images/new/Product.png" alt="reference-img" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
